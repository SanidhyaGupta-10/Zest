...
import { chatController, taskController, getChats, getChatMessages, ingestDocumentController, getUserSummaries, getUserNotes, getUserQuestions } from './ai.controller.js';
 ...
 * @access private
 */
router.post("/chat", rateLimit, chatController);
/**
 ...
 * @access private
 */
router.post("/tasks", rateLimit, taskController);
/**
 ...
 * @access private
 */
router.get("/history/summaries", getUserSummaries);
/**
 ...
 * @access private
 */
router.get("/history/notes", getUserNotes);
/**
 ...
 * @access private
 */
router.get("/history/questions", getUserQuestions);
/**
 ...
 * @access private
 */
router.post("/ingest", rateLimit, ingestDocumentController);
